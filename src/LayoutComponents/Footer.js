        ...
        <section className="col-lg-12 footer">
            ...
            <div className="col-lg-10 col-11 row mx-auto footer-main-section">
                ...
                <div className="col-lg-2 footer-section">
                    ...
                    <a href="/" className="footer-link font-14">Furnitures & Garden</a>
                    <a href="/" className="footer-link font-14">Electronics & Appliances</a>
                    <a href="/" className="footer-link font-14">Clothing & Accessories</a>
                    <a href="/" className="footer-link font-14">Jewellery & Watches</a>
                    <a href="/" className="footer-link font-14">Other ClassNameified Items</a>
                </div>
